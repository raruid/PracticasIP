...
int main(){
	...
	//Esquema while con la condicion de que el valor de la variable 'i' nunca sera mayor que el numero introducido
	while(i <= numero){
		...
		//variable iterativa que aumentara +1 en cada vuelta del bucle. Correspondera con los numeros comprendidos entre 1 y el numero introducido
		i++;
	}
